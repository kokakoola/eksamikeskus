...
$(document).ready(function() {
 ...
 $(function () {
     $('.toimumiskoht').editable({
         url: '/post',
         title: 'Sisesta toimumiskoht ja kohtade arv #',
         value: {
             toimumiskoht: "Rävala pst 3, Tallinn",
             kohti: "15"
         }
     });
 });
 (function ($) {
     ...
     Address.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
         tpl: '<div class="editable-address"><label><span>Toimumiskoht: </span><select>' +
                                                                                 '<option>Rävala pst 3, Tallinn</option>' +
                                                                                 '<option>Rävala pst 3, Tallinn</option>' +
                                                                                '</select></label></div>' +
              '<div class="editable-address"><label><span>Kohtade arv: </span><input type="text" name="street" class="input-small"></label></div>',
